...
class CGPersonalDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cgpersonal_detail)
        val db = FirebaseFirestore.getInstance()
        //textview
        val nameTV = findViewById<TextView>(R.id.namecgpd)
        val emailTV = findViewById<TextView>(R.id.emailcgpd)
        val contTV = findViewById<TextView>(R.id.contcgpd)
        val icTV  = findViewById<TextView>(R.id.iccgpd)

        //button
        val toMain = findViewById<Button>(R.id.backcgpdBtn)
        val edit = findViewById<Button>(R.id.editcgpdbtn)
        val reset = findViewById<Button>(R.id.resetcgBtn)
        val lo = findViewById<Button>(R.id.cgLogOutBtn)
        ...
        val docRef = db.collection("CareGiver").document(emailTV.text.toString())
        ...
        edit.setOnClickListener {
            val intent = Intent(this, CGEditPersonalDetail::class.java)
